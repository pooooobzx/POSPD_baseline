...
class MyDataSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        tgt_input = nltk.pos_tag(data[1].lower().split())
        ...
        return torch.tensor(numerical_src), torch.tensor(numerical_tgt_input),  torch.tensor(numerical_tgt_output2)
class MyCollate:
    ...
    def __call__(self, batch):
        ...
        return encode_inputs,torch.tensor(decode_inputs), torch.tensor(decode_outputs1)
